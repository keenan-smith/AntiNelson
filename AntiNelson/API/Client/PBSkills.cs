...
namespace PointBlank.API.Client
{
    public class PBSkills
    {
        ...
        {
            return PBPlayer.instance.player.skills.skills[(byte)skillset][ID].level;
        }

        public static PBSkills[] getSkills()
        {
            List<PBSkills> skills = new List<PBSkills>();
            PlayerSkills skill = PBPlayer.instance.player.skills;
